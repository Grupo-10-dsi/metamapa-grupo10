...
public class HechoServices {
    ...
    public void inicializarDatos() {
        ...
        String descMisiones = "La región de San Vicente en Misiones sufrió los efectos devastadores de una intensa tormenta con ráfagas de viento que superaron los 100 km/h. El fenómeno meteorológico causó voladuras de techos, caída de árboles y cortes en el suministro eléctrico. El incidente obligó a evacuar a varias familias de las zonas más afectadas. Las autoridades han convocado al comité de crisis provincial para coordinar las acciones de respuesta y asistir a los damnificados.";
