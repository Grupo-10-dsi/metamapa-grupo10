...
const urlsFuentes = {
    "ESTATICA": `${process.env.ESTATICA_URL}/api/estatica/hechos`,
    "DINAMICA": `${process.env.DINAMICA_URL}/api/dinamica/hechos`,
    "PROXY": `${process.env.PROXY_URL}/api/proxy/hechos`
}
